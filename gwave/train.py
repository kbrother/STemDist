...
from gwave_grad_freq import GwaveGradFreq
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--data', type=str, default='../data/PEMS-BAY', help='data path')
    ...
    elif args.agent == "ours_gf":  # gradient matching + frequency domain matching
        _tcond = GwaveGradFreq(dataloader, args, device)
