...
class Coreset:
    ...
    def test_syn(self):
        ...
        scaler = data['scaler']
        _model = gtnet(True, True, 1, num_nodes,
...
# python -m Sampling.core_set_mtgnn2 -de 2 -s 0 -lr 1e-2 -r 4e-3
# python -m Sampling.core_set_mtgnn2 -d ../data/PEMS-BAY -de 0 -s 0 -lr 1e-2 -r 4e-3
