    ...
    def train(self):
        ...
        for i in tqdm(range(args.epochs)):
            ...
            for ol in range(num_ol):            
                ...
                loss_real = torch.square(output_real - realy) * _weight
...
# python -m DC.distill_mtgnn_cluster_old -de 1 -d ../data/GBA_24 -e 100 -sp results/dc_gba_cluster_old -lrf 1e-3 -lrs 1e-3 -srr 0.1 -nrr 0.1 -b 128 -ned 32 -s 0 -c 1
# python -m DC.distill_mtgnn_cluster_old -de 6 -d ../data/GLA_24 -e 100 -sp results/dc_gla_cluster_old -lrf 1e-3 -lrs 1e-3 -srr 0.1 -nrr 0.1 -b 128 -ned 32 -s 0 -c 1
# python -m DC.distill_mtgnn_cluster_old -de 3 -d ../data/ERA5_24 -e 100 -sp results/dc_era5_cluster_old -lrf 1e-3 -lrs 1e-3 -srr 0.1 -nrr 0.1 -b 32 -ned 32 -s 0 -c 5
