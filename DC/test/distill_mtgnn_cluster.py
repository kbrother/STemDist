...
class GradMatchCluster:
    ...
    def train(self):
        ...
        optimizer = torch.optim.Adam([synx, syny], lr=1e-3)
...
# python -m DC.test.distill_mtgnn_cluster -de 0 -d ../data/GBA -sp results/cluster_gba.txt -srr 0.1 -nrr 0.05 -b 256 -ned 32 -s 0
