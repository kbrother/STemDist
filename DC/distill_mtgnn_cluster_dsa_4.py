...
# python -m DC.distill_mtgnn_cluster_dsa_4 -de 2 -d ../data/ERA5 -e 100 -sp results/dc_dsa_cluster_era5_1e-3 -lrf 1e-2 -lrs 1e-3 -srr 0.1 -nrr 0.1 -b 64 -ned 32 -s 0 -c 5
