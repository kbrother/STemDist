...
# python -m CondTSF.distill_dlinear_condtsf -de 0 -e 300 -d '../data/AURORA_final' --params '../data/params/AURORA-Dlinear/' -sp results/condtsf_aurora -sr 0.005 -lrf 1e-2 -lrs 1e-3 
