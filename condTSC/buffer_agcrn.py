...
# python -m condTSC.buffer_agcrn -de 1 -lr 1e-3 -s 0
# python -m condTSC.buffer_agcrn -de 2 -lr 1e-3 -s 1
# python -m condTSC.buffer_agcrn -de 3 -lr 1e-3 -s 2
# python -m condTSC.buffer_agcrn -de 5 -lr 1e-3 -s 3
        ...
        for i in range(args.epochs):
            ...
            with torch.no_grad():               
                ...
                with open(args.save_path + f"replay_buffer_{args.num_experts*args.seed + it}.txt", "a") as f:
                    f.write(f'epoch: {i}, valid mse: {val_mae}, test mse: {test_mae}\n')
