...
# python -m model.load_mtgnn_dsa2 -de 2 -d ../data/GLA -lr 0.001 -e 400 -b 128 -lp results/dc_dsa_cluster_gla_1e-3.pt -s 0 -ned 32
# python -m model.load_mtgnn_dsa2 -de 1 -d ../data/ERA5 -lr 0.001 -e 200 -b 128 -lp results/dc_dsa_cluster_era5_1e-3.pt -s 0 -ned 32
# python -m model.load_mtgnn_dsa2 -de 0 -d ../data/AURORA -lr 1e-3 -e 100 -b 64 -lp results/dc_dsa_cluster_aurora_1e-3_1e-3_3.pt -s 0 -ned 32
